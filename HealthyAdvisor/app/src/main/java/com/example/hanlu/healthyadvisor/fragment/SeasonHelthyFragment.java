 ...
 */
public class SeasonHelthyFragment extends BaseListFragment<HealthInfo> {
    ...
    protected void sendRequestData() {
        HealthyApi.getHealthyInfo(getContext(), 10, mCurrentPage, mHandler);
    }

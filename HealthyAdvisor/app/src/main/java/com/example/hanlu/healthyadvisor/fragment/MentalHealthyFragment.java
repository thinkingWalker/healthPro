 ...
 */
public class MentalHealthyFragment extends BaseListFragment<HealthInfo> {
    ...
    protected void sendRequestData() {
        HealthyApi.getHealthyInfo(getContext(), 9, mCurrentPage, mHandler);
    }

package com.example.hanlu.healthyadvisor.base;
...
import com.example.hanlu.healthyadvisor.bean.Entity;
import com.example.hanlu.healthyadvisor.bean.ListEntity;
import com.example.hanlu.healthyadvisor.utils.CacheManager;
...
//    protected Result mResult;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=View.inflate(getContext(), R.layout.fragment_list_base,null);
        return view;
    }
    ...
    protected ListEntity<T> parseList(byte[] is) throws Exception {
        return null;
    }
    ...
    protected void requestData(boolean refresh) {
        ...
        Log.i("json", "requestData: "+isReadCacheData(refresh));
...
//        }
    ...
    class ParserTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            try {
                final ListEntity<T> data = parseList(
                        reponseData);

 ...
 */
public class ChildrenHeathyFragment extends BaseListFragment<HealthInfo> {
    ...
    protected void sendRequestData() {
        HealthyApi.getHealthyInfo(getContext(), 2, mCurrentPage, mHandler);
    }
    @Override

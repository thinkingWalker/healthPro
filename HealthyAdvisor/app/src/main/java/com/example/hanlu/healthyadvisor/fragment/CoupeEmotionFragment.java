 ...
 */
public class CoupeEmotionFragment extends BaseListFragment<HealthInfo> {
    ...
    protected void sendRequestData() {
        HealthyApi.getHealthyInfo(getContext(), 13, mCurrentPage, mHandler);
    }
